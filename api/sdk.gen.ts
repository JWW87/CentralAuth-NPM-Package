...
export const getApiV1ApiRequestsByTenantId = <ThrowOnError extends boolean = false>(options: Options<GetApiV1ApiRequestsByTenantIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiV1ApiRequestsByTenantIdResponses, GetApiV1ApiRequestsByTenantIdErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiV1AuditLogsByTenantId = <ThrowOnError extends boolean = false>(options: Options<GetApiV1AuditLogsByTenantIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiV1AuditLogsByTenantIdResponses, GetApiV1AuditLogsByTenantIdErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
